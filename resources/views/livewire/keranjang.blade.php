                    ...
                    <table class="table text-center">
                        ...
                        <tbody>
                           ...
                           <tr>
                             <td>{{ $no++ }}</td>
                             <td>
                                <img src="{{ asset('storage/assets/'.$pesanan_detail->product->gambar) }}" class="img-fluid" width="200">
                             </td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td colspan="6" align="right"><strong>Total Yang Harus di Bayar : </strong></td>
